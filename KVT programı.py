...
for i in range (istenen_satir_olcutleri):
    ...
    veri = str(input("Satır ölçütü giriniz:"))          #SATIR İSMİ 
    liste1 = liste1 + [veri]
...
class pismanlik_olcutu:
    ...
    if(kontrol == 1):
        ...
        if((istenen_sutun_olcutleri == 2 and istenen_satir_olcutleri == 2) or (istenen_sutun_olcutleri == 2 and istenen_satir_olcutleri == 3)):
            ...
            for i in range(2):              #y1 den veriler yeni listeye atılıyor
            ...
            for i in range (istenen_satir_olcutleri*2):             #pişmanlık tablosu oluşturuluyor
            ...
            for i in range (2):         #pişmanlık ölçütündeki 0 değeri çıkarılıyor
